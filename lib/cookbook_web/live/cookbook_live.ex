  ...
  def render(assigns) do
    ...
    <div class="h-full flex flex-col gap-4 items-center">
      <div class="flex-grow flex flex-col gap-4 items-center justify-center">
        ...
        >
          <.icon name="hero-rocket-launch-mini" />
          Open in <span class="font-semibold">LVN Go</span>
        </.link>
      </div>
      <div class="w-full flex flex-grow flex-col gap-8 items-center justify-center border-zinc-200 border-t">
        ...
        <img
          ...
          class="max-w-32 md:max-w-56"
        />
        <p class="text-sm">Scan the code with <span class="font-semibold">LVN Go</span> to open the cookbook.</p>
      </div>
    </div>
    """
  end
